...
class QNimfPlatformInputContext : public QPlatformInputContext
{
  Q_OBJECT
public:
   QNimfPlatformInputContext ();
  ~QNimfPlatformInputContext ();
...
/* nimf signal callbacks */
void
QNimfPlatformInputContext::on_preedit_start (NimfIM *im, gpointer user_data)
{
  g_debug (G_STRLOC ": %s", G_STRFUNC);
}

void
QNimfPlatformInputContext::on_preedit_end (NimfIM *im, gpointer user_data)
{
  g_debug (G_STRLOC ": %s", G_STRFUNC);
}

void
QNimfPlatformInputContext::on_preedit_changed (NimfIM *im, gpointer user_data)
{
  g_debug (G_STRLOC ": %s", G_STRFUNC);
...
void
QNimfPlatformInputContext::on_commit (NimfIM      *im,
                             const gchar *text,
                             gpointer     user_data)
{
  g_debug (G_STRLOC ": %s", G_STRFUNC);
...
gboolean
QNimfPlatformInputContext::on_retrieve_surrounding (NimfIM *im, gpointer user_data)
{
  g_debug (G_STRLOC ": %s", G_STRFUNC);
  return FALSE;
}
...
gboolean
QNimfPlatformInputContext::on_delete_surrounding (NimfIM   *im,
                                         gint      offset,
                                         gint      n_chars,
                                         gpointer  user_data)
{
...
void
QNimfPlatformInputContext::on_beep (NimfIM *im, gpointer user_data)
{
  g_debug (G_STRLOC ": %s", G_STRFUNC);
...
void
QNimfPlatformInputContext::on_changed_reset_on_mouse_button_press (GSettings *settings,
                                                          gchar     *key,
                                                          gpointer   user_data)
{
  g_debug (G_STRLOC ": %s", G_STRFUNC);

  QNimfPlatformInputContext *context = static_cast<QNimfPlatformInputContext *>(user_data);
...
QNimfPlatformInputContext::QNimfPlatformInputContext ()
{
  g_debug (G_STRLOC ": %s", G_STRFUNC);
  ...
  g_signal_connect (m_im, "preedit-start",
                    G_CALLBACK (QNimfPlatformInputContext::on_preedit_start), this);
  g_signal_connect (m_im, "preedit-end",
                    G_CALLBACK (QNimfPlatformInputContext::on_preedit_end), this);
  g_signal_connect (m_im, "preedit-changed",
                    G_CALLBACK (QNimfPlatformInputContext::on_preedit_changed), this);
  g_signal_connect (m_im, "commit",
                    G_CALLBACK (QNimfPlatformInputContext::on_commit), this);
  g_signal_connect (m_im, "retrieve-surrounding",
                    G_CALLBACK (QNimfPlatformInputContext::on_retrieve_surrounding),
                    this);
  g_signal_connect (m_im, "delete-surrounding",
                    G_CALLBACK (QNimfPlatformInputContext::on_delete_surrounding),
                    this);
  g_signal_connect (m_im, "beep",
                    G_CALLBACK (QNimfPlatformInputContext::on_beep), this);

  g_signal_connect (m_settings, "changed::reset-on-mouse-button-press",
                    G_CALLBACK (QNimfPlatformInputContext::on_changed_reset_on_mouse_button_press), this);
  m_handler = NULL;
...
bool
QNimfPlatformInputContext::isValid () const
{
  g_debug (G_STRLOC ": %s", G_STRFUNC);
  return true;
}
...
void
QNimfPlatformInputContext::reset ()
{
  g_debug (G_STRLOC ": %s", G_STRFUNC);
  nimf_im_reset (m_im);
}
...
void
QNimfPlatformInputContext::commit ()
{
  g_debug (G_STRLOC ": %s", G_STRFUNC);
  nimf_im_reset (m_im);
}
...
void
QNimfPlatformInputContext::update (Qt::InputMethodQueries queries) /* FIXME */
{
  g_debug (G_STRLOC ": %s", G_STRFUNC);
...
void
QNimfPlatformInputContext::invokeAction(QInputMethod::Action, int cursorPosition)
{
  g_debug (G_STRLOC ": %s", G_STRFUNC);
}

bool
QNimfPlatformInputContext::filterEvent (const QEvent *event)
{
  g_debug (G_STRLOC ": %s", G_STRFUNC);
...
QRectF
QNimfPlatformInputContext::keyboardRect() const
{
  g_debug (G_STRLOC ": %s", G_STRFUNC);
  return QRectF ();
}
...
bool
QNimfPlatformInputContext::isAnimating() const
{
  g_debug (G_STRLOC ": %s", G_STRFUNC);
  return false;
}
...
void
QNimfPlatformInputContext::showInputPanel()
{
  g_debug (G_STRLOC ": %s", G_STRFUNC);
}

void
QNimfPlatformInputContext::hideInputPanel()
{
  g_debug (G_STRLOC ": %s", G_STRFUNC);
}

bool
QNimfPlatformInputContext::isInputPanelVisible() const
{
  g_debug (G_STRLOC ": %s", G_STRFUNC);
  return false;
}
...
QLocale
QNimfPlatformInputContext::locale() const
{
  g_debug (G_STRLOC ": %s", G_STRFUNC);
  return QLocale ();
}
...
Qt::LayoutDirection
QNimfPlatformInputContext::inputDirection() const
{
  g_debug (G_STRLOC ": %s", G_STRFUNC);
...
void
QNimfPlatformInputContext::setFocusObject (QObject *object)
{
  g_debug (G_STRLOC ": %s", G_STRFUNC);
...
/*
 * class QNimfPlatformInputContextPlugin
 */
class QNimfPlatformInputContextPlugin : public QPlatformInputContextPlugin
{
  Q_OBJECT
...
public:
  QNimfPlatformInputContextPlugin ()
  {
    g_debug (G_STRLOC ": %s", G_STRFUNC);
  }
                                         ...
                                         const QStringList &paramList)
  {
    ...
    return new QNimfPlatformInputContext ();
  }
};
